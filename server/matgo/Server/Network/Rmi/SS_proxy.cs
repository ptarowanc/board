...
namespace SS
{
    ...
    public class Proxy : ZNet.PKProxy
    {
        ...
        public bool RoomLobbyRequestMoveRoom(ZNet.RemoteID remote, ZNet.CPackOption pkOption, System.Guid roomID, ZNet.RemoteID remoteS, ZNet.RemoteID userRemote, int userID, long money, bool ipFree, bool shopFree, int shopId)
        {
            ZNet.CMessage Msg = new ZNet.CMessage();
        ...
        public bool RoomLobbyRequestMoveRoom(ZNet.RemoteID[] remotes, ZNet.CPackOption pkOption, System.Guid roomID, ZNet.RemoteID remoteS, ZNet.RemoteID userRemote, int userID, long money, bool ipFree, bool shopFree, int shopId)
        {
            foreach (var obj in remotes)
                RoomLobbyRequestMoveRoom(obj, pkOption, roomID, remoteS, userRemote, userID, money, ipFree, shopFree, shopId);
            return true;
        }
        ...
        public bool RelayRequestLobbyKey(ZNet.RemoteID remote, ZNet.CPackOption pkOption, ZNet.RemoteID userRemote, string id, string key, int gameid)
        {
            ZNet.CMessage Msg = new ZNet.CMessage();
            ...
            Rmi.Marshaler.Write(Msg, gameid);

            return PacketSend(remote, pkOption, Msg);
        }

        public bool RelayRequestLobbyKey(ZNet.RemoteID[] remotes, ZNet.CPackOption pkOption, ZNet.RemoteID userRemote, string id, string key, int gameid)
        {
            foreach (var obj in remotes)
                RelayRequestLobbyKey(obj, pkOption, userRemote, id, key, gameid);
            return true;
        }
        ...
        public bool LobbyRelayResponseLobbyKey(ZNet.RemoteID remote, ZNet.CPackOption pkOption, ZNet.RemoteID userRemote, string key, int gameid)
        {
            ZNet.CMessage Msg = new ZNet.CMessage();
        ...
        public bool LobbyRelayResponseLobbyKey(ZNet.RemoteID[] remotes, ZNet.CPackOption pkOption, ZNet.RemoteID userRemote, string key, int gameid)
        {
            foreach (var obj in remotes)
                LobbyRelayResponseLobbyKey(obj, pkOption, userRemote, key, gameid);
            return true;
        }
        ...
        public bool ResponseLobbyKey(ZNet.RemoteID remote, ZNet.CPackOption pkOption, string key, int gameid)
        {
            ZNet.CMessage Msg = new ZNet.CMessage();
        ...
        public bool ResponseLobbyKey(ZNet.RemoteID[] remotes, ZNet.CPackOption pkOption, string key, int gameid)
        {
            foreach (var obj in remotes)
                ResponseLobbyKey(obj, pkOption, key, gameid);
            return true;
        }
