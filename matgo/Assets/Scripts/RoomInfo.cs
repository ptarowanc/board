        ...
        switch (channel)
        {
            ...
            case 5:
                switch (betType)
                {
                    ...
                    case 2: roomBet = "300"; break;
                    case 3: roomBet = "500"; break;
                    case 4: roomBet = "1000"; break;
                    case 5: roomBet = "2000"; break;
                }
                break;
            case 6:
                switch (betType)
            ...
            case 7:
                switch (betType)
                {
                    ...
                    case 2: roomBet = "2"; break;
                    case 3: roomBet = "3"; break;
                    case 4: roomBet = "5"; break;
                    case 5: roomBet = "10"; break;
                }
                break;
            case 8:
                switch (betType)
