...
namespace SS
{
    ...
    public class Stub : ZNet.PKStub
    {
        ...
        public Server.Network.RelayServer RelayServerIns;
        public Server.Network.RelayLobbyServer RelayLobbyServerIns;
        ...
        public delegate bool RoomLobbyRequestMoveRoomDelegate(ZNet.RemoteID remote, ZNet.CPackOption pkOption, System.Guid roomID, ZNet.RemoteID remoteS, ZNet.RemoteID userRemote, int userID, long money, bool ipFree, bool shopFree, int shopId);
        public RoomLobbyRequestMoveRoomDelegate RoomLobbyRequestMoveRoom = delegate (ZNet.RemoteID remote, ZNet.CPackOption pkOption, System.Guid roomID, ZNet.RemoteID remoteS, ZNet.RemoteID userRemote, int userID, long money, bool ipFree, bool shopFree, int shopId)
        {
            return false;
        };
                ...
                case Common.RoomLobbyRequestMoveRoom:
                    {
                        ...
                        bool bRet = RoomLobbyRequestMoveRoom(remote, pkOption, roomID, remoteS, userRemote, userID, money, ipFree, shopFree, shopId);
                        if (bRet == false)
