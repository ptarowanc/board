...
namespace SS
{
    ...
    public class Proxy : ZNet.PKProxy
    {
        ...
        public bool ServerMoveStart(ZNet.RemoteID remote, ZNet.CPackOption pkOption, ZNet.NetAddress addr, ZNet.ArrByte param, Guid idx)
        {
            ZNet.CMessage Msg = new ZNet.CMessage();
        ...
        public bool ServerMoveStart(ZNet.RemoteID[] remotes, ZNet.CPackOption pkOption, ZNet.NetAddress addr, ZNet.ArrByte param, Guid idx)
        {
            foreach (var obj in remotes)
                ServerMoveStart(obj, pkOption, addr, param, idx);
            return true;
        }
