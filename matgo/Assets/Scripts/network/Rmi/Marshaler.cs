...
namespace Rmi
{
    public class Marshaler : ZNet.Marshaler
    {
        ...
        public class RoomInfo
        {
            ...
            public bool restrict;       // 입장제한 (true 면 입장 불가)
            public int remote_svr;      // 서버구분용 HostID번호 (입장할때 방이 어떤 서버에 존재하는지 정보)
            public int remote_lobby;    // 서버구분용 HostID번호 (원래입장시점의 로비서버 - 방에서 나갈때 사용)
