...
{    /// <summary>
    ...
    public class Common
    {
        ...
        static public void ServerMoveStart(CPlayer rc, out ZNet.ArrByte buffer)
        {
            ...
            msg.Write(rc.data.UserLevel);
            msg.Write(rc.data.GameLevel);
        ...
        static public void ServerMoveComplete(ZNet.ArrByte buffer, out CPlayer data)
        {
            ...
            //msg.Read(out rc.data.topMission);
            ...
            msg.Read(out rc.data.UserLevel);
            msg.Read(out rc.data.GameLevel);
